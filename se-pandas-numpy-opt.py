...
def create_dataframes():
    ...
    char_val_df.drop(
        char_val_df[
            (char_val_df.n >= char_val_df.e) | (char_val_df.s >= char_val_df.e)
            ].index, inplace=True
        )
    ...
    word_val_df.drop(word_val_df[(word_val_df.earth < word_val_df.north + word_val_df.south + word_val_df.east + word_val_df.west)].index, inplace=True)
...
def equation_test(word_val_df):
    ...
    word_val_df['earth_test'] = (word_val_df['north'].to_numpy() \
        ...
        + word_val_df['east'].to_numpy())

    word_val_df.drop(
        word_val_df[
            ~(word_val_df.earth == word_val_df.earth_test)
            ].index, inplace=True
        )
